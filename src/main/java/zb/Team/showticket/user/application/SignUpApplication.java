package zb.Team.showticket.user.application;
...
public class SignUpApplication {
    ...
    public String userSignUp(SignUpForm form) {
        if (userSignUpService.isEmailExist(form.getEmail())) {
            ...
            String text = getVerificationEmailBody(u.getEmail(),u.getName(),code);

            mailComponent.sendMail(email,subject,text);

            userSignUpService.ChangeCustomerValidationEmail(u.getId(), code);
